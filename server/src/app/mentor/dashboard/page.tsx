...
function StatusBadge({ status }: { status: "ACCEPTED" | "PENDING" | "REJECTED" }) {
  const styles = {
                        ...
                        <div className="flex items-center gap-3">
                          <div
                            className={`flex h-8 w-8 items-center justify-center rounded-full font-semibold text-sm ${
                              menteeAvatarColors[mentee.initials] || "bg-slate-200"
                            } ${
                              menteeAvatarTextColors[mentee.initials] || "text-slate-700"
                            }`}
                          >
                            {mentee.initials}
                          </div>
