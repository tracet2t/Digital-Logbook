		...
		<div className="flex min-h-screen bg-[#f5f7fb]">
			...
			<div className="flex-1 p-5 md:p-8">
				<Card className="overflow-hidden border-[#d9dde5] bg-white">
					<div className="border-b border-[#d9dde5] p-4 md:p-5">
						<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
							<div className="flex w-full items-center gap-2 md:max-w-xl">
								<div className="relative flex-1">
									<Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />
									<input
										className="h-10 w-full rounded-lg border border-[#dbe0e8] bg-white pl-10 pr-3 text-sm text-slate-700 outline-none transition focus:border-slate-400"
										type="search"
										value={search}
										onChange={(event) => {
