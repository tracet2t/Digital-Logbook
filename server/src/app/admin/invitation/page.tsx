...
export default function InvitationsView() {
  ...
  return (
    <>
      <AdminPageLayout className="bg-[#f5f5f7]">
        <div className="flex-1 px-8 py-6 space-y-6">
          {/* Parent card */}
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 space-y-6">
            {/* Sub-parent card: header + stats */}
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 space-y-6">
              <PageHeader
                title="Invitations"
                ...
                action={
                  <button
                    ...
                    className="inline-flex items-center gap-2 h-9 px-4 bg-[#18181B] hover:bg-[#27272A] text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
                  >
      ...
      <ConfirmDeleteDialog
        ...
        description="This will permanently delete the invitation and remove the associated user account along with all their data — including project allocations, activities, and feedback. This action cannot be undone."
      />
    </>
  );
}
