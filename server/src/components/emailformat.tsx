      ...
      >
        ...
        <div>
          <h1 style={{ color: "#1f2937", marginBottom: "1rem" }}>
            Welcome to Our Digital Logbook!
          </h1>
          ...
          <p style={{ color: "#4b5563", marginBottom: "1rem" }}>
            Use this password to log in to your account. We recommend changing
            it once you have successfully logged in.
          </p>
          <p style={{ color: "#4b5563", marginBottom: "1rem" }}>
        ...
        <div
          style={{ color: "#6b7280", marginTop: "1rem", fontSize: "0.875rem" }}
        >
